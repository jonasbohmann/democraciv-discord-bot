...
class DemocracivRole(PrettyEnum):
    ...
    # Executive
    MINISTER_ROLE = PrettyEnumValue(547530938712719373, 'Minister')
    GOVERNOR_ROLE = PrettyEnumValue(639438794239639573, 'Governor')
    EXECUTIVE_PROXY_ROLE = PrettyEnumValue(547530938712719373, 'Executive Proxy')
...
class DemocracivChannel(enum.Enum):
    ...
    # Government
    GOV_ANNOUNCEMENTS_CHANNEL = 679413729716338688
