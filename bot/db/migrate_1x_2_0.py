        ...
        async with connection.transaction():
            for grecord in guilds:
                ...
                for chan in grecord['logging_excluded']:
                    await connection.execute("INSERT INTO guild_private_channel (guild_id, channel_id) VALUES ($1, $2)",
                                             grecord['id'], chan)
            ...
            for srecord in selfroles:
                await connection.execute("INSERT INTO selfrole (guild_id, role_id, join_message) VALUES ($1, $2, $3)",
            ...
            for tr in tags:
                ...
                for al in alias:
                    await connection.execute("INSERT INTO tag_lookup (tag_id, alias) VALUES ($1, $2)",
                                             t_id, al['alias'])
            ...
            for sr in stars:
                ...
                for s in starr:
                    await connection.execute("INSERT INTO starboard_starrer (entry_id, starrer_id) VALUES ($1, $2)",
                                             e_id, s['starrer_id'])
