...
GOOGLE_CLOUD_PLATFORM_CLIENT_SECRETS_FILE = "bot/config/google_cloud_platform_client_secret.json"
GOOGLE_CLOUD_PLATFORM_CLIENT_OAUTH_CREDENTIALS_FILE = "bot/config/google_cloud_platform_oauth2_credentials.json"
