...
class Bank(context.CustomCog):
    ...
    async def organization(self, ctx, organization: BankCorporation = None):
        ...
        if organization is None:
            ...
            embed = text.SafeEmbed(description="Check out all corporations and organizations from around"
        ...
        embed = text.SafeEmbed(title=f"{organization.name} ({organization.abbreviation})",
    ...
    async def accounts(self, ctx):
        ...
        pages = paginator.SimplePages(entries=desc, author=f"{ctx.author.display_name}'s Bank Accounts",
    ...
    async def circulation(self, ctx):
        ...
        embed = text.SafeEmbed(title="Currency Circulation",
