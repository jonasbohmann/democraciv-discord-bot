...
async def main():
    ...
    async with db.acquire() as connection:
        async with connection.transaction():
            ...
            await connection.execute(f"""CREATE SEQUENCE legislature_sessions_seq START WITH {last_leg_session + 1};
            ...
            await connection.execute(f"""CREATE SEQUENCE legislature_bills_seq START WITH {last_bill + 1};
            ...
            await connection.execute(f"""CREATE SEQUENCE legislature_laws_seq START WITH {last_law + 1};
            ...
            await connection.execute(f"""CREATE SEQUENCE legislature_motions_seq START WITH {last_motion + 1};
            ...
            for tag in tags:
                await connection.execute("UPDATE guild_tags_alias SET global = $1 WHERE tag_id = $2", tag['global'],
                                         tag['id'])
